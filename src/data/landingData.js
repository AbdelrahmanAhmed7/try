...
export const landingData = {
  ...
  benefits: [
    ...
    '🚚 توصيل مجاني على معظم العروض',
    '💳 الدفع عند الاستلام',
  ],
  categoriesIntro: {
    eyebrow: 'تسوق حسب الفئة',
    title: 'Shop by Category',
    description: 'منتجاتنا الصحية في مكان واحد — اختار اللي يناسبك',
  },
  categories: [
    ...
    offers: [
      {
        ...
        description: 'اشتري 2 شرنك (12 عبوة) Healthy Cola (كولا 350 مل) واحصل على شرنك (12 عبوة) مجاناً + 5 Oat Bites مجاناً',
        price: 599,
        originalPrice: 900,
        saving: 301,
      ...
      },
      {
        ...
        title: 'عرض الكومبو',
        badge: '🎁 عرض خاص',
        amount: 'شرنك (12 عبوة) + 6 هدية',
        description: '12 عبوة Healthy Cola (كولا 350 مل · ليمون نعناع 350 مل) + 6 قطع هدية من اختيارك',
        price: 299,
        originalPrice: 450,
        saving: 151,
      ...
      },
      {
        ...
        badge: 'وفر أكتر 🔥',
        amount: 'شرنك (12 عبوة)',
        description: '12 عبوة Healthy Cola (كولا 350 مل · ليمون نعناع 350 مل)',
        price: 229,
        originalPrice: 300,
        saving: 71,
      ...
      },
      {
        ...
        badge: '☀️ عرض محدود',
        amount: '5 عبوات',
        description: '5 عبوات Healthy Cola (كولا 350 مل)',
        price: 99,
        originalPrice: 125,
        saving: 26,
  ...
  trust: [
    {
      id: 'shipping',
      title: 'توصيل للباب',
      desc: 'معظم الطلبات بتتوصّل لحد عندك بدون رسوم شحن.',
      icon: 'truck',
    },
    {
      id: 'cod',
      title: 'الدفع عند الاستلام',
      desc: 'ادفع لما تستلم طلبك — مفيش دفع مسبق.',
      icon: 'cash',
    },
    {
      id: 'products',
      title: 'منتجات مختارة',
      desc: 'كل منتج اتختار عشان يدي طعم حلو بمكونات أخف.',
      icon: 'leaf',
    },
    {
      id: 'easy',
      title: 'طلب سهل وسريع',
      desc: 'اختار، أضف للسلة، أدخل بياناتك — وهنكلمك لتأكيد الطلب.',
      icon: 'check',
    },
  ],
};
