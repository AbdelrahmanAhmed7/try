    ...
    offers: [
      {
        ...
        title: 'عرض الصيف',
        badge: '⭐ الأكثر طلبًا',
        amount: '2 شرنك (= ٢٤ زجاجة) + هدية + 5 Oat Bites',
        unit: 'كولا 350 مل',
        description: 'اشتري 2 شرنك Healthy Cola (كولا 350 مل · كل شرنك = ١٢ زجاجة) واحصل على شرنك مجاناً + 5 Oat Bites مجاناً',
        price: 599,
        originalPrice: 900,
        saving: 301,
      ...
      },
      {
        ...
        title: 'عرض الكومبو',
        badge: '🎁 عرض خاص',
        amount: 'شرنك (= ١٢ زجاجة) + 6 هدية',
        unit: 'كولا 350 مل',
        description: '12 عبوة Healthy Cola (كولا 350 مل · ليمون نعناع 350 مل · كل شرنك = ١٢ زجاجة) + 6 قطع هدية من اختيارك',
        price: 299,
        originalPrice: 450,
        saving: 151,
      ...
      },
      {
        ...
        title: 'عرض الشرنك',
        badge: 'وفر أكتر 🔥',
        amount: 'شرنك (= ١٢ زجاجة)',
        unit: 'كولا 350 مل',
        description: '12 عبوة Healthy Cola (كولا 350 مل · ليمون نعناع 350 مل · كل شرنك = ١٢ زجاجة)',
        price: 229,
        originalPrice: 300,
        saving: 71,
    ...
    offers: [
      {
        ...
        description: '٣ برطمانات Healthy Spread (375 جرام) + ١ شرنك Healthy Cola (كولا 350 مل · كل شرنك = ١٢ زجاجة)',
        price: 900,
        originalPrice: 1200,
        saving: 300,
        image: bundleImg,
      ...
      },
      {
        ...
        categoryId: 'bundles',
        title: 'Bundle 2',
        amount: '٢ برطمان سبريد + نص شرنك كولا (٦ زجاجات)',
        unit: 'برطمان 375 جرام + كولا 350 مل',
        description: '٢ برطمانات Healthy Spread (375 جرام) + ٦ عبوات Healthy Cola (كولا 350 مل) — نص شرنك (الشرنك = ١٢ زجاجة)',
        price: 550,
        originalPrice: 750,
        saving: 200,
        image: bundleImg2,
